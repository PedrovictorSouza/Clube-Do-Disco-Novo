...
const HomeHeroSection: React.FC = () => {
    ...
    const anchors = useMemo(() => {
        ...
        return {
            ...
            "about": hero.H * 1.8,     // About aparece quando scroll atinge 1.8 * H
            "contact": hero.H * 2.55,  // Contact aparece quando scroll atinge 2.55 * H
        };
    }, [hero.scrollY, hero.H]);
    ...
    const activeId =
        ...
        hero.stage === 4 ? "contact" : // CORREÇÃO: stage 4 também é contact
        "contact";
    ...
    const handleGoto = (id: string) => {
        ...
        if (id === "about") {
            ...
            const contactY = hero.H * 3.3; // Y=3300 para stage 4
